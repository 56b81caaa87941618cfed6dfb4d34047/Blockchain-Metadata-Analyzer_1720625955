    ...
    <header class="w-full z-30" id="header-section-container">
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <div id="site-branding" class="flex-1"><a id="logo-link" class="inline-flex" href="index.html" aria-label="Cruip"><img id="logo-image" class="max-w-none" src="static/img/generate-an-image-for-a-logo-for-the-website-based-on-the-project-description-create-an-app-for-the-purpose-of-analysing-new-blockchain-metadata-information.png" width="38" height="38" alt="Stellar"></a></div>
